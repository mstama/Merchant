...
[Roman numerals](https://en.wikipedia.org/wiki/Roman_numerals) are based on seven symbols:
...
A number written in [Arabic numerals](https://en.wikipedia.org/wiki/Arabic_numerals) can be broken into digits. For example, 1903 is
