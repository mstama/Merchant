...
namespace Merchant.Services
{
    ...
    public class CommandRegexParser : ICommandParser
    {
        ...
        private readonly Regex _manyExpression = new Regex(_manyPattern, RegexOptions.CultureInvariant & RegexOptions.IgnoreCase);
        private readonly Regex _mapExpression = new Regex(_mapPattern, RegexOptions.CultureInvariant & RegexOptions.IgnoreCase);
        private readonly Regex _muchExpression = new Regex(_muchPattern, RegexOptions.CultureInvariant & RegexOptions.IgnoreCase);
        private readonly Regex _rateExpression = new Regex(_ratePattern, RegexOptions.CultureInvariant & RegexOptions.IgnoreCase);
